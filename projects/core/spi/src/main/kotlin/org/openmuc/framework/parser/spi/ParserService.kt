...
interface ParserService {
    ...
    fun serialize(openMucRecord: LoggingRecord?): ByteArray?
     ...
     */
    @Throws(SerializationException::class)
    fun serialize(openMucRecords: List<LoggingRecord?>?): ByteArray?

    /**
     * Deserializes a given JSON-String as byte array to [org.openmuc.framework.data.Record]. The format of the
     ...
     * @return deserialized instance of [org.openmuc.framework.data.Record]
     */
    fun deserialize(byteArray: ByteArray?, valueType: ValueType?): Record?
}
