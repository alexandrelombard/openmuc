...
/**
 * Flags indicates the state of a record. It identifies which type of error occurred or if the value is valid.<br></br>
 * More informations of the occurred errors can often seen in the OpenMUC log files in the "log" folder.
 */
enum class Flag(private val code: Int) {
    /**
     * Flag 1: Valid data.
     */
    VALID(1),
    ...
    /**
     * Flag 11: The driver with the configured driver id could not found. Possible reasons:<br></br>
     * - the driver bundle is missing<br></br>
    ...
    companion object {
        private val idMap: MutableMap<Byte, Flag?> = HashMap()
        ...
        fun newFlag(code: Int): Flag {
            return idMap[code.toByte()]
                ?: throw IllegalArgumentException("Unknown Flag code: $code")
        }
    }
}
