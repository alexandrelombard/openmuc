...
enum class ESamplingMode {
    /**
     * Csv file must contain a column with the name *unixtimestamp*, values must be in milliseconds. During
    ...
    /**
     * Csv file must contain a column with the name *hhmmss*, values must be in the format: hhmmss.
     */
    HHMMSS,
